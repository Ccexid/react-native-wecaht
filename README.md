...
Xcode11打包 Wechat版本过低 作者有没更新 自己手动替换了最新的WeChat 1.8.7的版本.
源项目链接:https://github.com/shanchaojie/react-native-wechat-mini
...
WeChat.registerApp('appid','link');
```

#### registerAppWithDescription(appid, description)

- `appid` {String} the appid you get from WeChat dashboard
- `link` {String} the link you get from WeChat Universal Links
...
拉取到本地替换IOS目录下OpenWechat库，以及RCTWeChat.m文件